...
const navigation = [
  ...
  { name: 'Colleges', href: '/admin/colleges', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
  { name: 'Departments', href: '/admin/departments', icon: 'M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z' },
  ...
  { name: 'Courses', href: '/admin/courses', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
  ...
  { name: 'Exam Schedules', href: '/admin/exam-schedules', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 bg-indigo-800">
          <span className="text-xl font-bold text-white">Exam Attendance</span>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between h-16 px-4 bg-white shadow">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-sm text-gray-700">
              {user && 'firstName' in user ? `${user.firstName} ${user.lastName}` : 'Admin'}
            </span>
            <button
